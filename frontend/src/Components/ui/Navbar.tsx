          ...
          <div className="flex items-center space-x-4">
            {isAuthenticated ? (
                ...
                <div className="relative group">
                  <button className="flex items-center space-x-2 focus:outline-none">
                    <img
                      src={userData.avatar}
                      alt={userData.name}
                      className="w-10 h-10 rounded-full border-2 border-indigo-300 hover:border-indigo-500 transition-colors shadow-sm"
                    />
                  ...
                  <div className="absolute z-50 right-0 mt-2 w-48 bg-white rounded-lg shadow-lg py-2 border border-indigo-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200">
                    ...
                    <button
                      ...
                      className="block w-full text-left px-4 py-2 text-sm text-red-600 hover:bg-red-50 transition-colors border-t border-indigo-100"
                    >
                      Sign Out
                    </button>
                  </div>
              ...
              <>
                ...
                <Link
                  to="/register"
                  className="px-5 py-2 bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-md hover:shadow-indigo-200/50"
                >
                  Get Started
                </Link>
              </>
